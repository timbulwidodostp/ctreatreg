...
{pstd} {cmd:*** 1. EXAMPLE WITH CT-OLS ***}
   ...
   {inp:. import excel "https://raw.githubusercontent.com/timbulwidodostp/ctreatreg/main/ctreatreg/ctreatreg.xlsx", sheet("Sheet1") firstrow clear}   
   {inp:. xi: ctreatreg wage treatment $xvars, graphdrf delta(10) hetero($xvarh) model(ct-ols) ct(tenure2) ci(1) m(3) s(10)} 

{pstd} {cmd:*** 2. EXAMPLE WITH CT-IV ***}

   {inp:. xi: ctreatreg wage treatment $xvars, graphdrf delta(10) hetero($xvarh) model(ct-iv) ct(tenure2) ci(1) m(3) s(10) estype(twostep) iv_t(ttl_exp) iv_w(c_city)}
...
{phang}Timbul Widodo Olah Data Semarang{p_end}
